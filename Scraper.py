...
class Scraper:
    ...
    def scrape(self):
        ...
        games_list, teams_list, scores_list, times_list = self.parse_events(parsed_json_dict)
        ...
        for game in games_list:
            database.append({"name": game, "date": times_list[j][:times_list[j].index('T')],
                             ...
                             "teams": {"teamA": teams_list[i], "teamAScore": scores_list[i],
    ...
    def parse_events(self, events_dict):
        ...
        return games_list, teams_list, scores_list, times_list
